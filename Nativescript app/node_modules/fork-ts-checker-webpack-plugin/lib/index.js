...
class ForkTsCheckerWebpackPlugin {
    ...
    pluginEmit() {
        const emit = (compilation, callback) => {
            ...
            this.afterCompileCallback = this.createAfterCompileCallback(compilation, callback);
            if (this.checkDone) {
    ...
    createAfterCompileCallback(compilation, callback) {
        return function afterCompileCallback() {
            if (!this.elapsed) {
    ...
    createNoopAfterCompileCallback() {
