    ...
    var TapAndDoubleTapGestureListenerImpl = (function (_super) {
        ...
        TapAndDoubleTapGestureListenerImpl.prototype._handleDoubleTap = function (motionEvent) {
            ...
            if (this._type & gestures_common_1.GestureTypes.doubleTap) {
                var args = _getDoubleTapArgs(this._target, motionEvent);
                _executeCallback(this._observer, args);
            }
        };
...
function _getDoubleTapArgs(view, e) {
    return {
        type: gestures_common_1.GestureTypes.doubleTap,
        view: view,
        android: e,
        getX: function () { return e.getX() / utils_1.layout.getDisplayDensity(); },
        getY: function () { return e.getY() / utils_1.layout.getDisplayDensity(); },
        ios: undefined,
        object: view,
        eventName: gestures_common_1.toString(gestures_common_1.GestureTypes.doubleTap),
    };
}
