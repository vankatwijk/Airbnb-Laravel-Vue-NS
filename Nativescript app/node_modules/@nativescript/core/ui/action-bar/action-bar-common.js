...
function convertToContentInset(value) {
    if (typeof value === "string" && value !== "auto") {
        ...
        return [
            ...
            [exports.androidContentInsetRightProperty, view_2.Length.parse(insets[1] || insets[0])]
        ];
    }
    else {
        return [
...
var androidContentInsetProperty = new properties_1.ShorthandProperty({
    ...
    getter: function () {
        if (view_2.Length.equals(this.androidContentInsetLeft, this.androidContentInsetRight)) {
            return this.androidContentInsetLeft;
        }
        return view_2.Length.convertToString(this.androidContentInsetLeft) + " " + view_2.Length.convertToString(this.androidContentInsetRight);
    },
...
exports.androidContentInsetLeftProperty = new properties_1.CssProperty({
    ...
    defaultValue: "auto", equalityComparer: view_2.Length.equals,
    valueChanged: function (target, oldValue, newValue) {
        ...
        if (view) {
            ...
            view_1.traceWrite(newValue + " not set to view's property because \".viewRef\" is cleared", view_1.traceCategories.Style, view_1.traceMessageType.warn);
        }
