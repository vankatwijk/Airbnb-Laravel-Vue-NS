...
function loadActionIconDrawableOrResourceId(item) {
    ...
    if (utils_1.isFontIconURI(itemIcon)) {
        ...
        var is = image_source_1.ImageSource.fromFontIconCodeSync(fontIconCode, font, color);
        if (is && is.android) {
...
var ActionBar = (function (_super) {
    ...
    ActionBar.prototype[action_bar_common_1.androidContentInsetLeftProperty.setNative] = function () {
        if (apiLevel >= 21) {
            this.nativeViewProtected.setContentInsetsAbsolute(this.effectiveContentInsetLeft, this.effectiveContentInsetRight);
        }
    };
    ActionBar.prototype[action_bar_common_1.androidContentInsetRightProperty.setNative] = function () {
        if (apiLevel >= 21) {
            this.nativeViewProtected.setContentInsetsAbsolute(this.effectiveContentInsetLeft, this.effectiveContentInsetRight);
        }
    };
