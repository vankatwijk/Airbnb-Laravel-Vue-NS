    ...
    KeyframeAnimation.prototype.animate = function (view, index, iterations) {
        ...
        if (index === 0) {
            ...
            if ("rotate" in animation) {
                view.style[style_properties_1.rotateXProperty.keyframe] = animation.rotate.x;
                view.style[style_properties_1.rotateYProperty.keyframe] = animation.rotate.y;
                view.style[style_properties_1.rotateProperty.keyframe] = animation.rotate.z;
            }
