...
function transformAst(node, css, type) {
    ...
    if (node.type === "StyleSheet") {
        return {
            type: "stylesheet",
            stylesheet: {
                rules: node.children.map(function (child) { return transformAst(child, css); }).toArray(),
                parsingErrors: []
            }
        };
    }
    ...
    if (node.type === "Block") {
        return node.children.map(function (child) { return transformAst(child, css, type); }).toArray();
    }
    if (node.type === "Rule") {
