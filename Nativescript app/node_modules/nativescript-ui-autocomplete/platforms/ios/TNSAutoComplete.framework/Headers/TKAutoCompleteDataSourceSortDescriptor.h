//
//  TKAutoCompleteDataSourceSortDescriptor.h
//  TelerikUI
//
...
/**
 A sort descriptor that is used in TKDataSourceExtended to sort items.
 */
@interface TKAutoCompleteDataSourceSortDescriptor : NSObject
